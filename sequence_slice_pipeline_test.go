...
func TestSequenceSlicePipeline(t *testing.T) {
	...
	t.Run("simple iteration", func(t *testing.T) {
		doubles := NewSequenceSlicePipeline("MapDouble", double, false)
		input := []int{1, 2, 3, 4, 5}
	...
	t.Run("error in iteration stops", func(t *testing.T) {
		doubles := NewSequenceSlicePipeline("MapDoubleStop", positiveDouble, true)
		input := []int{1, 2, -1, 4, 5}
	...
	t.Run("error in iteration continues", func(t *testing.T) {
		doubles := NewSequenceSlicePipeline("MapDoubleStop", positiveDouble, false)
		input := []int{1, 2, -1, 4, 5}
	...
	t.Run("panic in iteration", func(t *testing.T) {
		divides := NewSequenceSlicePipeline("MapDivide10", divide10, false)
