...
func TestParallelMapPipeline(t *testing.T) {
	...
	t.Run("simple iteration", func(t *testing.T) {
		doubles := NewParallelMapPipeline[string, int]("MapDouble", double)
	...
	t.Run("error in iteration continues", func(t *testing.T) {
		doubles := NewParallelMapPipeline[string, int]("MapDoubleStop", positiveDouble)
	...
	t.Run("panic in iteration", func(t *testing.T) {
		divides := NewParallelMapPipeline[string, int]("MapDivide10", divide10)
