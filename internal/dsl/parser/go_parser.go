...
func goparserParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"STRUCT", "SWITCH", "TYPE", "VAR", "IDENTIFIER", "L_PAREN", "R_PAREN",
		...
		"BIT_CLEAR", "UNDERLYING", "EXCLAMATION", "PLUS", "MINUS", "CARET",
	...
	staticData.serializedATN = []int32{
		4, 1, 89, 1019, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		196, 198, 200, 202, 204, 206, 208, 210, 0, 9, 1, 0, 39, 40, 2, 0, 51, 56,
		59, 63, 2, 0, 36, 36, 88, 88, 1, 0, 58, 64, 2, 0, 52, 56, 62, 63, 2, 0,
		51, 51, 59, 61, 1, 0, 45, 50, 2, 0, 65, 68, 72, 73, 1, 0, 79, 80, 1076,
		...
		0, 242, 243, 5, 27, 0, 0, 243, 7, 1, 0, 0, 0, 244, 256, 5, 15, 0, 0, 245,
		257, 3, 10, 5, 0, 246, 252, 5, 28, 0, 0, 247, 248, 3, 10, 5, 0, 248, 249,
		3, 210, 105, 0, 249, 251, 1, 0, 0, 0, 250, 247, 1, 0, 0, 0, 251, 254, 1,
		0, 0, 0, 252, 250, 1, 0, 0, 0, 252, 253, 1, 0, 0, 0, 253, 255, 1, 0, 0,
		0, 254, 252, 1, 0, 0, 0, 255, 257, 5, 29, 0, 0, 256, 245, 1, 0, 0, 0, 256,
		246, 1, 0, 0, 0, 257, 9, 1, 0, 0, 0, 258, 261, 5, 38, 0, 0, 259, 261, 3,
		...
		0, 0, 0, 272, 284, 5, 4, 0, 0, 273, 285, 3, 18, 9, 0, 274, 280, 5, 28,
		...
		5, 29, 0, 0, 398, 387, 1, 0, 0, 0, 398, 388, 1, 0, 0, 0, 399, 47, 1, 0,
		0, 0, 400, 408, 3, 20, 10, 0, 401, 404, 3, 122, 61, 0, 402, 403, 5, 34,
		0, 0, 403, 405, 3, 22, 11, 0, 404, 402, 1, 0, 0, 0, 404, 405, 1, 0, 0,
		0, 405, 409, 1, 0, 0, 0, 406, 407, 5, 34, 0, 0, 407, 409, 3, 22, 11, 0,
		408, 401, 1, 0, 0, 0, 408, 406, 1, 0, 0, 0, 409, 49, 1, 0, 0, 0, 410, 411,
		5, 30, 0, 0, 411, 412, 3, 52, 26, 0, 412, 413, 5, 31, 0, 0, 413, 51, 1,
		0, 0, 0, 414, 418, 5, 36, 0, 0, 415, 418, 5, 88, 0, 0, 416, 418, 1, 0,
		...
		0, 0, 453, 454, 3, 158, 79, 0, 454, 455, 5, 64, 0, 0, 455, 456, 3, 158,
		...
		5, 34, 0, 0, 468, 67, 1, 0, 0, 0, 469, 470, 3, 20, 10, 0, 470, 471, 5,
		41, 0, 0, 471, 472, 3, 22, 11, 0, 472, 69, 1, 0, 0, 0, 473, 474, 5, 27,
		0, 0, 474, 476, 5, 37, 0, 0, 475, 477, 3, 54, 27, 0, 476, 475, 1, 0, 0,
		0, 476, 477, 1, 0, 0, 0, 477, 71, 1, 0, 0, 0, 478, 480, 5, 21, 0, 0, 479,
		481, 3, 22, 11, 0, 480, 479, 1, 0, 0, 0, 480, 481, 1, 0, 0, 0, 481, 73,
		1, 0, 0, 0, 482, 484, 5, 1, 0, 0, 483, 485, 5, 27, 0, 0, 484, 483, 1, 0,
		0, 0, 484, 485, 1, 0, 0, 0, 485, 75, 1, 0, 0, 0, 486, 488, 5, 5, 0, 0,
		487, 489, 5, 27, 0, 0, 488, 487, 1, 0, 0, 0, 488, 489, 1, 0, 0, 0, 489,
		77, 1, 0, 0, 0, 490, 491, 5, 13, 0, 0, 491, 492, 5, 27, 0, 0, 492, 79,
		...
		1, 0, 0, 0, 532, 533, 1, 0, 0, 0, 533, 537, 5, 30, 0, 0, 534, 536, 3, 90,
		45, 0, 535, 534, 1, 0, 0, 0, 536, 539, 1, 0, 0, 0, 537, 535, 1, 0, 0, 0,
		537, 538, 1, 0, 0, 0, 538, 540, 1, 0, 0, 0, 539, 537, 1, 0, 0, 0, 540,
		541, 5, 31, 0, 0, 541, 89, 1, 0, 0, 0, 542, 543, 3, 92, 46, 0, 543, 544,
		5, 37, 0, 0, 544, 545, 3, 52, 26, 0, 545, 91, 1, 0, 0, 0, 546, 547, 5,
		...
		566, 5, 30, 0, 0, 563, 565, 3, 98, 49, 0, 564, 563, 1, 0, 0, 0, 565, 568,
		1, 0, 0, 0, 566, 564, 1, 0, 0, 0, 566, 567, 1, 0, 0, 0, 567, 569, 1, 0,
		0, 0, 568, 566, 1, 0, 0, 0, 569, 570, 5, 31, 0, 0, 570, 95, 1, 0, 0, 0,
		571, 572, 5, 27, 0, 0, 572, 574, 5, 41, 0, 0, 573, 571, 1, 0, 0, 0, 573,
		574, 1, 0, 0, 0, 574, 575, 1, 0, 0, 0, 575, 576, 3, 160, 80, 0, 576, 577,
		5, 38, 0, 0, 577, 578, 5, 28, 0, 0, 578, 579, 5, 25, 0, 0, 579, 580, 5,
		29, 0, 0, 580, 97, 1, 0, 0, 0, 581, 582, 3, 100, 50, 0, 582, 583, 5, 37,
		...
		0, 0, 594, 597, 5, 35, 0, 0, 595, 598, 3, 122, 61, 0, 596, 598, 5, 18,
		...
		5, 22, 0, 0, 605, 609, 5, 30, 0, 0, 606, 608, 3, 106, 53, 0, 607, 606,
		1, 0, 0, 0, 608, 611, 1, 0, 0, 0, 609, 607, 1, 0, 0, 0, 609, 610, 1, 0,
		0, 0, 610, 612, 1, 0, 0, 0, 611, 609, 1, 0, 0, 0, 612, 613, 5, 31, 0, 0,
		613, 105, 1, 0, 0, 0, 614, 615, 3, 108, 54, 0, 615, 616, 5, 37, 0, 0, 616,
		...
		0, 627, 628, 5, 34, 0, 0, 628, 633, 1, 0, 0, 0, 629, 630, 3, 20, 10, 0,
		630, 631, 5, 41, 0, 0, 631, 633, 1, 0, 0, 0, 632, 626, 1, 0, 0, 0, 632,
		...
		0, 0, 0, 657, 658, 3, 22, 11, 0, 658, 659, 5, 34, 0, 0, 659, 664, 1, 0,
		0, 0, 660, 661, 3, 20, 10, 0, 661, 662, 5, 41, 0, 0, 662, 664, 1, 0, 0,
		...
		64, 0, 676, 677, 5, 28, 0, 0, 677, 678, 3, 122, 61, 0, 678, 679, 5, 29,
		0, 0, 679, 681, 1, 0, 0, 0, 680, 671, 1, 0, 0, 0, 680, 675, 1, 0, 0, 0,
		680, 676, 1, 0, 0, 0, 681, 123, 1, 0, 0, 0, 682, 683, 5, 32, 0, 0, 683,
		685, 3, 102, 51, 0, 684, 686, 5, 35, 0, 0, 685, 684, 1, 0, 0, 0, 685, 686,
		1, 0, 0, 0, 686, 687, 1, 0, 0, 0, 687, 688, 5, 33, 0, 0, 688, 125, 1, 0,
		0, 0, 689, 692, 3, 174, 87, 0, 690, 692, 5, 27, 0, 0, 691, 689, 1, 0, 0,
		...
		1, 0, 0, 0, 703, 704, 5, 32, 0, 0, 704, 705, 3, 132, 66, 0, 705, 706, 5,
		33, 0, 0, 706, 707, 3, 134, 67, 0, 707, 131, 1, 0, 0, 0, 708, 709, 3, 158,
		79, 0, 709, 133, 1, 0, 0, 0, 710, 711, 3, 122, 61, 0, 711, 135, 1, 0, 0,
		0, 712, 713, 5, 62, 0, 0, 713, 714, 3, 122, 61, 0, 714, 137, 1, 0, 0, 0,
		715, 716, 5, 16, 0, 0, 716, 725, 5, 30, 0, 0, 717, 720, 3, 146, 73, 0,
		...
		0, 0, 726, 728, 1, 0, 0, 0, 727, 725, 1, 0, 0, 0, 728, 729, 5, 31, 0, 0,
		729, 139, 1, 0, 0, 0, 730, 731, 5, 32, 0, 0, 731, 732, 5, 33, 0, 0, 732,
		733, 3, 134, 67, 0, 733, 141, 1, 0, 0, 0, 734, 735, 5, 17, 0, 0, 735, 736,
		5, 32, 0, 0, 736, 737, 3, 122, 61, 0, 737, 738, 5, 33, 0, 0, 738, 739,
		3, 134, 67, 0, 739, 143, 1, 0, 0, 0, 740, 741, 4, 72, 0, 0, 741, 747, 5,
		3, 0, 0, 742, 743, 5, 3, 0, 0, 743, 747, 5, 64, 0, 0, 744, 745, 5, 64,
		0, 0, 745, 747, 5, 3, 0, 0, 746, 740, 1, 0, 0, 0, 746, 742, 1, 0, 0, 0,
		746, 744, 1, 0, 0, 0, 747, 748, 1, 0, 0, 0, 748, 749, 3, 134, 67, 0, 749,
		145, 1, 0, 0, 0, 750, 751, 5, 27, 0, 0, 751, 752, 3, 154, 77, 0, 752, 753,
		3, 152, 76, 0, 753, 757, 1, 0, 0, 0, 754, 755, 5, 27, 0, 0, 755, 757, 3,
		...
		153, 1, 0, 0, 0, 769, 781, 5, 28, 0, 0, 770, 775, 3, 156, 78, 0, 771, 772,
		5, 35, 0, 0, 772, 774, 3, 156, 78, 0, 773, 771, 1, 0, 0, 0, 774, 777, 1,
		0, 0, 0, 775, 773, 1, 0, 0, 0, 775, 776, 1, 0, 0, 0, 776, 779, 1, 0, 0,
		0, 777, 775, 1, 0, 0, 0, 778, 780, 5, 35, 0, 0, 779, 778, 1, 0, 0, 0, 779,
		780, 1, 0, 0, 0, 780, 782, 1, 0, 0, 0, 781, 770, 1, 0, 0, 0, 781, 782,
		1, 0, 0, 0, 782, 783, 1, 0, 0, 0, 783, 784, 5, 29, 0, 0, 784, 155, 1, 0,
		0, 0, 785, 787, 3, 20, 10, 0, 786, 785, 1, 0, 0, 0, 786, 787, 1, 0, 0,
		0, 787, 789, 1, 0, 0, 0, 788, 790, 5, 42, 0, 0, 789, 788, 1, 0, 0, 0, 789,
		...
		815, 3, 158, 79, 4, 808, 809, 10, 2, 0, 0, 809, 810, 5, 44, 0, 0, 810,
		815, 3, 158, 79, 3, 811, 812, 10, 1, 0, 0, 812, 813, 5, 43, 0, 0, 813,
		...
		1, 0, 0, 0, 826, 835, 1, 0, 0, 0, 827, 828, 5, 38, 0, 0, 828, 834, 5, 27,
		...
		840, 5, 28, 0, 0, 840, 842, 3, 158, 79, 0, 841, 843, 5, 35, 0, 0, 842,
		841, 1, 0, 0, 0, 842, 843, 1, 0, 0, 0, 843, 844, 1, 0, 0, 0, 844, 845,
		5, 29, 0, 0, 845, 163, 1, 0, 0, 0, 846, 856, 3, 166, 83, 0, 847, 849, 3,
		172, 86, 0, 848, 850, 3, 124, 62, 0, 849, 848, 1, 0, 0, 0, 849, 850, 1,
		0, 0, 0, 850, 856, 1, 0, 0, 0, 851, 852, 5, 28, 0, 0, 852, 853, 3, 158,
		79, 0, 853, 854, 5, 29, 0, 0, 854, 856, 1, 0, 0, 0, 855, 846, 1, 0, 0,
		...
		194, 97, 0, 865, 867, 5, 69, 0, 0, 866, 862, 1, 0, 0, 0, 866, 863, 1, 0,
		0, 0, 866, 864, 1, 0, 0, 0, 866, 865, 1, 0, 0, 0, 867, 169, 1, 0, 0, 0,
		868, 869, 7, 7, 0, 0, 869, 171, 1, 0, 0, 0, 870, 873, 5, 27, 0, 0, 871,
		873, 3, 174, 87, 0, 872, 870, 1, 0, 0, 0, 872, 871, 1, 0, 0, 0, 873, 173,
		1, 0, 0, 0, 874, 875, 5, 27, 0, 0, 875, 876, 5, 38, 0, 0, 876, 877, 5,
		27, 0, 0, 877, 175, 1, 0, 0, 0, 878, 879, 3, 178, 89, 0, 879, 880, 3, 180,
		90, 0, 880, 177, 1, 0, 0, 0, 881, 894, 3, 190, 95, 0, 882, 894, 3, 130,
		65, 0, 883, 884, 5, 32, 0, 0, 884, 885, 5, 42, 0, 0, 885, 886, 5, 33, 0,
		...
		5, 30, 0, 0, 896, 898, 3, 182, 91, 0, 897, 899, 5, 35, 0, 0, 898, 897,
		1, 0, 0, 0, 898, 899, 1, 0, 0, 0, 899, 901, 1, 0, 0, 0, 900, 896, 1, 0,
		0, 0, 900, 901, 1, 0, 0, 0, 901, 902, 1, 0, 0, 0, 902, 903, 5, 31, 0, 0,
		903, 181, 1, 0, 0, 0, 904, 909, 3, 184, 92, 0, 905, 906, 5, 35, 0, 0, 906,
		908, 3, 184, 92, 0, 907, 905, 1, 0, 0, 0, 908, 911, 1, 0, 0, 0, 909, 907,
		1, 0, 0, 0, 909, 910, 1, 0, 0, 0, 910, 183, 1, 0, 0, 0, 911, 909, 1, 0,
		0, 0, 912, 913, 3, 186, 93, 0, 913, 914, 5, 37, 0, 0, 914, 916, 1, 0, 0,
		...
		0, 0, 928, 934, 5, 30, 0, 0, 929, 930, 3, 192, 96, 0, 930, 931, 3, 210,
		105, 0, 931, 933, 1, 0, 0, 0, 932, 929, 1, 0, 0, 0, 933, 936, 1, 0, 0,
		0, 934, 932, 1, 0, 0, 0, 934, 935, 1, 0, 0, 0, 935, 937, 1, 0, 0, 0, 936,
		934, 1, 0, 0, 0, 937, 938, 5, 31, 0, 0, 938, 191, 1, 0, 0, 0, 939, 940,
		...
		950, 952, 5, 62, 0, 0, 951, 950, 1, 0, 0, 0, 951, 952, 1, 0, 0, 0, 952,
		...
		1, 0, 0, 0, 961, 962, 5, 32, 0, 0, 962, 963, 3, 158, 79, 0, 963, 964, 5,
		33, 0, 0, 964, 201, 1, 0, 0, 0, 965, 981, 5, 32, 0, 0, 966, 968, 3, 158,
		79, 0, 967, 966, 1, 0, 0, 0, 967, 968, 1, 0, 0, 0, 968, 969, 1, 0, 0, 0,
		969, 971, 5, 37, 0, 0, 970, 972, 3, 158, 79, 0, 971, 970, 1, 0, 0, 0, 971,
		972, 1, 0, 0, 0, 972, 982, 1, 0, 0, 0, 973, 975, 3, 158, 79, 0, 974, 973,
		1, 0, 0, 0, 974, 975, 1, 0, 0, 0, 975, 976, 1, 0, 0, 0, 976, 977, 5, 37,
		0, 0, 977, 978, 3, 158, 79, 0, 978, 979, 5, 37, 0, 0, 979, 980, 3, 158,
		79, 0, 980, 982, 1, 0, 0, 0, 981, 967, 1, 0, 0, 0, 981, 974, 1, 0, 0, 0,
		982, 983, 1, 0, 0, 0, 983, 984, 5, 33, 0, 0, 984, 203, 1, 0, 0, 0, 985,
		986, 5, 38, 0, 0, 986, 987, 5, 28, 0, 0, 987, 988, 3, 122, 61, 0, 988,
		989, 5, 29, 0, 0, 989, 205, 1, 0, 0, 0, 990, 1005, 5, 28, 0, 0, 991, 998,
		3, 22, 11, 0, 992, 995, 3, 122, 61, 0, 993, 994, 5, 35, 0, 0, 994, 996,
		3, 22, 11, 0, 995, 993, 1, 0, 0, 0, 995, 996, 1, 0, 0, 0, 996, 998, 1,
		0, 0, 0, 997, 991, 1, 0, 0, 0, 997, 992, 1, 0, 0, 0, 998, 1000, 1, 0, 0,
		0, 999, 1001, 5, 42, 0, 0, 1000, 999, 1, 0, 0, 0, 1000, 1001, 1, 0, 0,
		0, 1001, 1003, 1, 0, 0, 0, 1002, 1004, 5, 35, 0, 0, 1003, 1002, 1, 0, 0,
		0, 1003, 1004, 1, 0, 0, 0, 1004, 1006, 1, 0, 0, 0, 1005, 997, 1, 0, 0,
		0, 1005, 1006, 1, 0, 0, 0, 1006, 1007, 1, 0, 0, 0, 1007, 1008, 5, 29, 0,
		0, 1008, 207, 1, 0, 0, 0, 1009, 1010, 3, 122, 61, 0, 1010, 1011, 5, 38,
		0, 0, 1011, 1012, 5, 27, 0, 0, 1012, 209, 1, 0, 0, 0, 1013, 1017, 5, 36,
		0, 0, 1014, 1017, 5, 88, 0, 0, 1015, 1017, 4, 105, 9, 0, 1016, 1013, 1,
