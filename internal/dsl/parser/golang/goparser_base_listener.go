...
func (s *BaseGoParserListener) EnterPackageName(ctx *PackageNameContext) {}

// ExitPackageName is called when production packageName is exited.
func (s *BaseGoParserListener) ExitPackageName(ctx *PackageNameContext) {}

// EnterIdentifier is called when production identifier is entered.
func (s *BaseGoParserListener) EnterIdentifier(ctx *IdentifierContext) {}

// ExitIdentifier is called when production identifier is exited.
func (s *BaseGoParserListener) ExitIdentifier(ctx *IdentifierContext) {}
...
func (s *BaseGoParserListener) EnterCondition(ctx *ConditionContext) {}

// ExitCondition is called when production condition is exited.
func (s *BaseGoParserListener) ExitCondition(ctx *ConditionContext) {}
